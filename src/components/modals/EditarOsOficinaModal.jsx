...
export default function EditarOsOficinaModal({ open, onClose, osItem, onSuccess }) {
  ...
  const fieldClass = "w-full bg-slate-900 border border-white/10 rounded-lg px-3 py-2 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500";
    ...
    <Modal open={open} onClose={onClose} title="✏️ Editar Ordem de Serviço da Oficina" size="md">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <div>
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Sonda</label>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Turma</label>
          ...
          <div className="col-span-2 sm:col-span-3">
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Sondador</label>
            <input type="text" placeholder="Nome do sondador" className={fieldClass} value={form.sondador} onChange={handleChange('sondador')} />
          </div>

          <div className="col-span-2 sm:col-span-3">
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Componente / Peça</label>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Saiu Nº (Defeito)</label>
            <input type="text" placeholder="Ex: 01" className={fieldClass} value={form.saiuNumero} onChange={handleChange('saiuNumero')} />
          </div>

          <div className="col-span-2">
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Entrou Nº (Substituição na Sonda)</label>
          ...
          <div className="col-span-2 sm:col-span-3">
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Problema / Defeito</label>
            <textarea
              rows={2}
